...
public class Planete {
	...
	public String info1() {
		String info1;
		info1="Bonjour � toi je suis "+nom+", ravie de te rencontrer. \n On dit de moi que je suis une plan�te de type"+type;
		if (type=="Tellurique"){
			info1=info1+", c'est a dire que je suis composee essentiellement de roches et de m�tal qui possede trois enveloppes "
					+ "concentriques (noyau, manteau et cro�te). \n Ma surface est solide et composee principalement de mat�riaux"
	...
	public String info3() {
		String info3;
		if (type=="Tellurique"){
			info3= "Le myst�re est mon ma�tre mot, soit il fait froide soit il fait chaud, je varie de "+temperaturemin+"�C � " +temperaturemax+"�C.\n ";
		}
		else {
			info3="Je suis vraiment desolee mais chez moi il fait assez froid:je varie de"+temperaturemin+"�C �" +temperaturemax+"�C; mais ne t'en fait pas j'ai "
	...
	public String info4() {
		...
		if (pesanteur<10){
			info4="Youpi!!! Tu es tout leger chez moi, tu veux conna�tre ton poids, clic sur le bouton\n ";
		} else {
			info4="Oulalallala tu as trop mang� aujourd'hui, tu veux conna�tre ton poids, clic sur le bouton\n ";
		}
